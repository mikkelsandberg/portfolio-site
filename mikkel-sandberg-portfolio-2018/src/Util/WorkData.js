		...
		images: [
			{
				...
				caption:
					"The final page after migrating the content into the new CMS and new template."
			},
			{
				...
				caption:
					"The old page used a tabbed navigation to separate the content."
			},
			{
		...
		images: [
			{
				...
				url:
					"https://s3-us-west-1.amazonaws.com/msandberg-portfolio-2018/ee/ee-profile-page.jpg",
		...
		images: [
			{
				...
				url:
					"https://s3-us-west-1.amazonaws.com/msandberg-portfolio-2018/ee/ee-live-landing-logged-out.jpg",
		...
		images: [
			{
				...
				url:
					"https://s3-us-west-1.amazonaws.com/msandberg-portfolio-2018/jammming/jammming-search-results.png",
				caption: "The search results view for the Jammming app."
			},
			{
				subTitle: "Playlist view",
				url:
					"https://s3-us-west-1.amazonaws.com/msandberg-portfolio-2018/jammming/jammming-playlist.png",
		...
		images: [
			{
				...
				url:
					"https://s3-us-west-1.amazonaws.com/msandberg-portfolio-2018/friend-quest/friend-quest-artwork.png",
