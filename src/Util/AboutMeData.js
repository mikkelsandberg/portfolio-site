const AboutMeData = {
	profilePic: 'https://s3-us-west-1.amazonaws.com/msandberg-portfolio-2018/mikkel-beach-square.png',
	stats: [
		{
		...
		{
			stat: "<a href='https://github.com/MikkelSandbag' target='_blank'>Github profile</a>",
			icon: ['fab', 'github']
		}
	],
