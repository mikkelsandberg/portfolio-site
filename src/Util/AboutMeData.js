const AboutMeData = {
	...
	stats: [
		...
		{
			stat:
				"<a href='https://github.com/MikkelSandbag' target='_blank' rel='noopener noreferrer'>Github profile</a>",
			icon: ['fab', 'github'],
		},
	],
	introText:
		'Hi there! My name is Mikkel and I am a web developer and podcast producer based in California.',
	bodyContent: [
